...
public class InventoryService {
 ...
 return inventoryRepository.findByWarehouse(warehouse, pageable);
    ...
    public Page<Inventory> searchInventory(String productId, String variantId, String warehouseId,
        ...
        // This is a basic implementation. For more complex combinations of search
        // criteria,
        // you might need to implement a custom query using Specifications or a native query.
 ...
 return inventoryRepository.findByProductAndVariant(product, variant, pageable);
        ...
        return inventoryRepository.findAll(pageable); // Default to fetching all with pagination if no specific criteria
    }
}